define(['dispatcher', 'TweenMax', 'page-transition/page-transition.store', 'resize/resize.store', 'utils', 'svg-text/svg-text.store'], function(dispatcher, TweenMax, store, resizeStore, utils, textStore) {
